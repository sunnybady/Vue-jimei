...
<template>
    ...
    <div class="input">
        <p>员工姓名:
        <el-input v-model="proPrice" placeholder="请输入员工姓名" /></p>
        <p>员工职位:  
            <el-select v-model="project" placeholder="请输入员工职位" size="large">
  ...
  <el-table :data="computedTableData"  style="width: 100%">
    <el-table-column prop="proCard" label="员工编号" width="180" />
    <el-table-column prop="proName" label="员工姓名" width="180" />
    <el-table-column prop="proPrice" label="员工职位" />
    <el-table-column prop="remarks" label="员工电话" ></el-table-column>
   ...
   <!-- 新增项目/修改项目 -->
   <el-dialog v-model="addForm" :title="interfaceType == '10086' ? '新增员工' : '修改员工信息'" width="400px">
    <el-form :model="form">
      ...
      <el-form-item label="员工姓名" :label-width="formLabelWidth">
        <el-input v-model="form.proName" autocomplete="off"  placeholder="请输入员工姓名"/>
      </el-form-item>
          <!-- 项目价格 -->
      <el-form-item label="员工职位" :label-width="formLabelWidth">
        <el-input v-model="form.proPrice" autocomplete="off" placeholder="请输入项目价格"/>
      </el-form-item>

       <!-- 备注 -->
       <el-form-item label="员工电话" :label-width="formLabelWidth">
        <el-input v-model="form.remarks" autocomplete="off" placeholder="请输入员工电话"/>
      </el-form-item>
    </el-form>
    <template #footer>
